      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              "flex h-auto min-h-10 w-full items-center justify-between rounded-md border bg-inherit p-1 font-normal hover:bg-inherit dark:bg-input/30 [&_svg]:pointer-events-auto",
              className,
            )}
          >
